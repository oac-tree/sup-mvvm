...
#ifndef MVVM_PLOTTING_GRAPH_VIEWPORT_PLOT_CONTROLLER_H_
#define MVVM_PLOTTING_GRAPH_VIEWPORT_PLOT_CONTROLLER_H_
...
#endif  // MVVM_PLOTTING_GRAPH_VIEWPORT_PLOT_CONTROLLER_H_
