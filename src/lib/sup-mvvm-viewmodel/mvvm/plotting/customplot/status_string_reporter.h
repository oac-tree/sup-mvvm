...
#ifndef MVVM_PLOTTING_CUSTOMPLOT_STATUS_STRING_REPORTER_H_
#define MVVM_PLOTTING_CUSTOMPLOT_STATUS_STRING_REPORTER_H_
...
#endif  // MVVM_PLOTTING_CUSTOMPLOT_STATUS_STRING_REPORTER_H_
