...
#include "mvvm/project/new_project_manager.h"
...
class NewProjectManagerTests : public mvvm::test::FolderBasedTest
{
public:
  NewProjectManagerTests()
...
TEST_F(NewProjectManagerTests, InitialState)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, UntitledEmptyNew)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, UntitledEmptySave)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, UntitledEmptySaveAs)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, UntitledModifiedNew)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, UntitledModifiedSave)
{
  NewProjectManager manager(CreateContext());
  // modifying the model
  sample_model->InsertItem<PropertyItem>();
...
TEST_F(NewProjectManagerTests, UntitledModifiedSaveAs)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, TitledUnmodifiedNew)
{
  NewProjectManager manager(CreateContext());
...
TEST_F(NewProjectManagerTests, TitledModifiedSave)
{
  NewProjectManager manager(CreateContext());
