...
/**
 * @brief Tests for SelectableComboPropertyEditor class.
 */
class SelectableComboBoxEditorTest : public ::testing::Test
{
};

TEST_F(SelectableComboBoxEditorTest, SetValueAndToolTip)
{
  SelectableComboBoxEditor editor;
