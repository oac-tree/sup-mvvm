...
class ApplicationModelV2Tests : public ::testing::Test
{
public:
  ApplicationModelV2 m_model;
};

TEST_F(ApplicationModelV2Tests, InitialState)
{
...
TEST_F(ApplicationModelV2Tests, SetData)
{
...
TEST_F(ApplicationModelV2Tests, SetDataThroughItem)
{
  auto item = m_model.InsertItem<PropertyItem>();
...
TEST_F(ApplicationModelV2Tests, SetSameData)
{
  auto item = m_model.InsertItem<PropertyItem>();
...
TEST_F(ApplicationModelV2Tests, InsertItemIntoRoot)
{
...
TEST_F(ApplicationModelV2Tests, InsertItemIntoRootViaMove)
{
  SessionItem* expected_parent = m_model.GetRootItem();
  TagIndex expected_tag_index{"rootTag", 0};  // default tag of root item
...
TEST_F(ApplicationModelV2Tests, InsertItemIntoParentUsingTagAndIndex)
{
...
TEST_F(ApplicationModelV2Tests, InsertItemIntoParentUsingTagAndIndexViaGetModel)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), false);
...
TEST_F(ApplicationModelV2Tests, InsertItemInDefaultTag)
{
  auto parent = m_model.InsertItem<CompoundItem>();
...
TEST_F(ApplicationModelV2Tests, InsertItemInDefaultTagWhenNoDefaultIsPresent)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), false);
...
TEST_F(ApplicationModelV2Tests, InsertItemInPropertyTag)
{
  auto parent = m_model.InsertItem<CompoundItem>();
...
TEST_F(ApplicationModelV2Tests, InsertItemViaMove)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), true);
...
TEST_F(ApplicationModelV2Tests, TakeItem)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), true);
...
TEST_F(ApplicationModelV2Tests, RemoveItem)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), true);
  auto child = m_model.InsertItem<PropertyItem>(parent);
...
TEST_F(ApplicationModelV2Tests, MoveItem)
{
...
TEST_F(ApplicationModelV2Tests, IvalidItemMove)
{
  auto parent1 = m_model.InsertItem<CompoundItem>();
...
TEST_F(ApplicationModelV2Tests, Clear)
{
  auto parent = m_model.InsertItem<CompoundItem>();
  parent->RegisterTag(TagInfo::CreateUniversalTag("tag"), true);
...
TEST_F(ApplicationModelV2Tests, Destroy)
{
  auto model = std::make_unique<ApplicationModelV2>();
