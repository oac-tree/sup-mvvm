...
class SessionModelV2Test : public ::testing::Test
{
public:
  ...
  class TestModel : public SessionModelV2
  {
  public:
    TestModel()
        : SessionModelV2("TestModelType", CreateDefaultItemManager(m_pool),
...
std::shared_ptr<ItemPool> SessionModelV2Test::m_pool = std::make_shared<ItemPool>();

TEST_F(SessionModelV2Test, InitialState)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, SetData)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemIntoRoot)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemIntoRootViaMove)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemIntoParentUsingTagAndIndex)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemInDefaultTag)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemInDefaultTagViaAppend)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemInDefaultTagWhenNoDefaultTagIsPresent)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemInPropertyTag)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertNewItemInPropertyTag)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InsertItemIntoParentViaMove)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, RemoveItem)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, TakeItem)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, RemoveFromWrongParent)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItem)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemRootContextNext)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemRootContextSamePos)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemRootContextPrev)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemRootContextLast)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemRootContextLast2)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemFromRootToParent)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, InvalidMoveOfParentProperty)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemBetweenParentTags)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, MoveItemFromParentToRoot)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, ClearModel)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, ClearWithRootReplace)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, FindItem)
{
  TestModel model;
...
TEST_F(SessionModelV2Test, FindItemInAlienModel)
{
  // models contains common pool
...
TEST_F(SessionModelV2Test, RegisterItem)
{
