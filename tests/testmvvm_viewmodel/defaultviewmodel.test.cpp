...
//  pxData = dynamic_cast<ViewDataItem*>(viewModel.itemFromIndex(viewModel.index(1, 1,
//  vectorIndex))); EXPECT_EQ(pxLabel->item(), vectorItem->getItem(VectorItem::P_Y));
...
//  pxData = dynamic_cast<ViewDataItem*>(viewModel.itemFromIndex(viewModel.index(2, 1,
//  vectorIndex))); EXPECT_EQ(pxLabel->item(), vectorItem->getItem(VectorItem::P_Z));
