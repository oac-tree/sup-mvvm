...
{
  static std::map<int, std::string> type_name_map = {{0, constants::kUndefinedTypeName},
                                                     {1, constants::kBoolTypeName},
                                                     {2, constants::kIntTypeName},
                                                     {3, constants::kDoubleTypeName},
                                                     ...
                                                     {8, constants::kIntLimitsPropertyTypeName},
                                                     {9, constants::kRealLimitsPropertyTypeName}};
