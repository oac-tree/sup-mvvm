...
ItemPool::identifier_t ItemPool::register_item(SessionItem* item, ItemPool::identifier_t key)
...
ItemPool::identifier_t ItemPool::key_for_item(const SessionItem* item) const
{
...
SessionItem* ItemPool::item_for_key(const ItemPool::identifier_t &key) const
{
