...
#ifndef MVVM_MODEL_SESSIONMODEL_V2_H_
#define MVVM_MODEL_SESSIONMODEL_V2_H_
...
class MVVM_MODEL_EXPORT SessionModelV2 : public SessionModelInterface
{
public:
  using SessionModelInterface::InsertItem;

  SessionModelV2(std::string model_type, std::unique_ptr<ItemManagerInterface> manager,
                 std::unique_ptr<ModelComposerInterface> composer);

  ~SessionModelV2() override;
  SessionModelV2(const SessionModelV2& other) = delete;
  SessionModelV2& operator=(const SessionModelV2& other) = delete;
...
#endif  // MVVM_MODEL_SESSIONMODEL_V2_H_
